              ...
              <Container className="pl-4">
                ...
                <p className="pb-4 pl-2">
                  <List bulleted>
                    ...
                    <List.Item><a href="https://stravaboards.oddwes.ca" target="_blank" rel="noreferrer">stravaboards.oddwes.ca</a></List.Item>
                  </List>
                </p>
              </Container>
              <Container className="pl-4">
                ...
                <p className="pb-4 pl-2">
                  <List bulleted>
                    ...
                    <List.Item><a href="https://resume.oddwes.ca" target="_blank" rel="noreferrer">resume.oddwes.ca</a></List.Item>
                  </List>
                </p>
              </Container>
            </Container>
